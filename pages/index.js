					...
					<div className='sm:border-b-2 sm:border-gray-200'>
						<header>
							...
							<div className='flex items-center justify-between px-4 py-3 sm:px-6'>
								...
								<div className='flex items-center'>
									<span className='hidden sm:inline-flex p-0.5 bg-gray-200 border rounded-md'>
							...
							<div className='flex p-1 px-4 bg-gray-200 border-t border-b border-gray-300 sm:hidden'>
								<button className='inline-flex items-center justify-center w-1/2 px-3 py-1.5'>
									<svg
										className='w-6 h-6 text-gray-600'
										fill='none'
										stroke='currentColor'
